...
class InstrScr(Screen):
    def __init__(self, **kwargs):
        ...
        lbl1 = Label(text='Введите возраст:', halign='right')
        self.btn = Button(text='Начать', size_hint=(0.3, 0.2 ), pos_hint=('center_x: 0.5'))
        self.btn.on_press = self.next
        line1 = BoxLayout(size_hint=(0.8, None), height='30sp')
        line2 = BoxLayout(size_hint=(0.8, None), height='30sp')
        line1.add.widget(lbl1)
        line1.add_widget(self.in_name)
        line2.add_widget(lbl2)
        line2.add_widget(self.in_age)
        outer = BoxLayout(orientation='vertical', padding=8, spacing=8)
        outer.add_widget(instr)
        outer.add_widhet(line1)
        outer.add_widget(line2)
        outer.add.Widget(self.btn)
...
class PulseScr(Screen):
    def __init__(self, **kwargs):
        ...
        lbl_result = Label(text='Введите результат:', height='right')
        ...
        self.btn.on_press = self.next
        outer =  BoxLayout(instr)
        outer =  BoxLayout(line)
        outer =  BoxLayout(self.btn)
...
class PulseScr2(Screen):
    def __init__(self, **kwargs):
        ...
        line2.Box_Layout(size_hint(0.8, None), height='30sp')
